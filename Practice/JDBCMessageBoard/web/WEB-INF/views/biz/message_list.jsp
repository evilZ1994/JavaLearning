    ...
    <body>
        <header>
            <div class="container">
                <% if (null != request.getSession().getAttribute("user")) {%>
                    <nav>
                        <a href="<%=request.getContextPath()%>/my/message/list.do">我的留言</a>
                    </nav>
                    <nav>
                        <a href="<%=request.getContextPath()%>/userInfo.do">我的信息</a>
                    </nav>
                <%} else { %>
                    <nav>
        ...
        <section class="page">
            <div class="container">
                <% if (null != request.getSession().getAttribute("user")) {%>
                    <div id="fatie">
                        <a href="<%=request.getContextPath()%>/addMessagePrompt.do"><button>点我留言</button></a>
                    </div>
                <%} else { %>
                    <div id="fatie">
                        请<a href="<%=request.getContextPath()%>/login.do"><button>登录</button></a>后留言
                    </div>
                <% } %>
